...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of FDJRouterSwift.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/likethephoenix@163.com/FDJRouterSwift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'likethephoenix@163.com' => 'likethephoenix@163.com' }
  s.source           = { :git => 'https://github.com/likethephoenix@163.com/FDJRouterSwift.git', :tag => s.version.to_s }
